...
powershell -NoProfile -Command "Invoke-WebRequest -Uri 'https://github.com/woct0rdho/SageAttention/releases/download/v2.2.0-windows.post5/sageattention-2.2.0+cu130torch2.10.0andhigher.post5-cp310-abi3-win_amd64.whl' -OutFile 'sageattention-2.2.0+cu130torch2.10.0andhigher.post5-cp310-abi3-win_amd64.whl'"
if %errorlevel% neq 0 (
...
powershell -NoProfile -Command "Invoke-WebRequest -Uri 'https://huggingface.co/Wildminder/AI-windows-whl/resolve/main/flash_attn-2.8.4+d20260328cu130torch2.12.0cxx11abiTRUE-cp313-cp313-win_amd64.whl' -OutFile 'flash_attn-2.8.4+d20260328cu130torch2.12.0cxx11abiTRUE-cp313-cp313-win_amd64.whl'"
if %errorlevel% neq 0 (
